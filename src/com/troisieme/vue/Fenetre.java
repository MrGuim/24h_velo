...
public class Fenetre extends JFrame {
	...
	public static String currentRouleur;
	private JScrollPane scrollPane;

	private JMenuBar menuBar = new JMenuBar();
	private JMenu options = new JMenu("Options"), aProposMenu = new JMenu("À propos");
	private JMenuItem statJoueur = new JMenuItem("Statistiques joueurs"),
			chronoTroupe = new JMenuItem("Chrono des autres troupes"),
			peloton = new JMenuItem("Peloton"), aProposItem = new JMenuItem("?");
	...
	public static int secG = 0;
	public static int minG = 0;
	public static boolean flagPeloton = false;
	...
	PelotonFenetre pelotonFenetre = new PelotonFenetre();
	...
	public Fenetre() {
		...
		peloton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				pelotonFenetre.showPeloton();
			}
		});

		/*
		 * aProposMenu.addMenuListener(new MenuListener(){ public void
		 * menuSelected(MenuEvent event){ aPropos.showAPropos(); } public void
		...
		timer = new Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (secTimer == 0 && minTimer == 0 && hourTimer == 0) {
					...
					JOptionPane.showMessageDialog(null, "La course est finie!", "Information course",
		...
		((DefaultTableModel) table.getModel()).setColumnIdentifiers(new String[] { "N° du tour", "Nom", "Temps" });
		...
		btnTourFini.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				// je sais bien que ca prend du temps et qu'on perd en fluidite mais je sais pas
				// faire autrement avec mes connaissances actuels
				...
				outFile.flush();
				currentRouleur = (String) ((DefaultTableModel) table.getModel()).getValueAt(count, 1);
				if (flagPeloton) {
					pelotonFenetre.putTemps();
					flagPeloton = false;
				}
		...
		btnSecondTour.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = count + 1; i < ((DefaultTableModel) table.getModel()).getRowCount(); i++)
					((DefaultTableModel) table.getModel()).setValueAt(String.valueOf(
							((Integer.parseInt((String) ((DefaultTableModel) table.getModel()).getValueAt(i, 0))) + 1)),
							i, 0);
				minChrono = 0;
				secChrono = 0;
				chrono.start();
				...
				// on rejoute une row dans le tableau a notre count+1 et on inscrit le coureur
				// dans le fichier txt
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addGap(60).addGroup(gl_contentPane
								.createParallelGroup(Alignment.TRAILING).addComponent(btnTourFini)
								.addComponent(btnAjouterRouleur)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(
												label_2, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)
										.addGap(10)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
												.addGroup(gl_contentPane.createSequentialGroup()
														.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 30,
																GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(label_4, GroupLayout.PREFERRED_SIZE, 84,
																GroupLayout.PREFERRED_SIZE)
														.addGap(68))
												.addComponent(btnSecondTour)))))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(89).addComponent(lblChronoActuel,
								GroupLayout.PREFERRED_SIZE, 138, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(98).addComponent(btnPause,
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(58)
								...
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblDerniersTemps, GroupLayout.PREFERRED_SIZE, 150,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(secLabel, GroupLayout.PREFERRED_SIZE, 89,
												GroupLayout.PREFERRED_SIZE))))
				.addContainerGap(10, Short.MAX_VALUE))
				.addGroup(gl_contentPane.createSequentialGroup().addGap(170)
						.addComponent(hourLabel, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(lblTempsRestant)
										.addContainerGap())
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(label)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												.addComponent(minLabel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
														84, Short.MAX_VALUE)
												.addComponent(btnStart, GroupLayout.PREFERRED_SIZE, 84,
														GroupLayout.PREFERRED_SIZE))
										.addGap(345)))));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblTempsRestant)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGap(11)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(lblChronoActuel, GroupLayout.PREFERRED_SIZE, 22,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
														.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 48,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(label_4, GroupLayout.PREFERRED_SIZE, 48,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(label_2)))
										.addComponent(lblDerniersTemps, GroupLayout.PREFERRED_SIZE, 22,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnPause).addGap(53)
								.addComponent(btnAjouterRouleur)
								.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnTourFini).addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(btnSecondTour)))
				.addGap(35)));
